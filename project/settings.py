...
# BASE_DIR is probably already defined near the top of settings.py:
# BASE_DIR = Path(__file__).resolve().parent.parent

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'   # uploaded files will live at project-root/media/


# CORS settings (development convenience)
CORS_ALLOW_ALL_ORIGINS = True   # quick and easy for local dev
...
INSTALLED_APPS = [
    ...
    # Third-party
    'rest_framework',
    'rest_framework.authtoken',   # Token auth (provided by DRF)
    'corsheaders',                # Allow frontend (React) to call API
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',    # <-- ADD this first (or near top)
